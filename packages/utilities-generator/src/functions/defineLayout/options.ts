...
import { DefineLayoutOptions } from ".";

// Layouts don't have layout key or access to the asyncData function
type OmitKeys = keyof DefineLayoutOptions | "layout" | "asyncData";
