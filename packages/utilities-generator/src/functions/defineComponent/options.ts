...
import { DefineComponentOptions } from ".";

// Components don't have layout or middleware key and does not access to the asyncData function
type OmitKeys = keyof DefineComponentOptions | "layout" | "asyncData" | "middleware";
...
export interface KudraComponentOptionsBase<
    ...
    Defaults = {}
> extends Omit<Vue2ComponentOptions<Vue, D, M, C,Props>,'data' | 'computed' | 'methods' | 'setup' | 'props' | 'mixins' | 'extends'  | OmitKeys> {
  // allow any options
  [key: string]: any
